        ...
        <div>
            <main>
                ...
                <section className="relative pt-20 pb-16 px-6 overflow-hidden">
                    <motion.div
                        className="absolute top-0 left-1/2 w-[800px] h-[400px] bg-primary/10 blur-[120px] rounded-full -z-10"
                        initial={{ x: '-50%', y: 0 }}
                        animate={{ x: '-50%', y: [0, -18, 0] }}
                    ...
                    <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
                        ...
                        <Reveal delay={300}>
                            <div className="flex flex-col sm:flex-row items-center gap-4 w-full justify-center">
                                <a href="/studio" className="w-full sm:w-auto flex items-center justify-center gap-2 min-w-[200px] h-14 rounded-xl bg-primary text-white text-base font-bold hover:bg-blue-700 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-primary/20 group">
                                    Get Started
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-0 sm:divide-x sm:divide-slate-200 dark:sm:divide-slate-800 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm py-8 px-6 hover:shadow-md transition-shadow duration-300">
                                {stats.map((s, i) => (
                                    <div key={i} className="flex-1 text-center px-8">
                                        <div className="text-3xl md:text-4xl font-black text-primary mb-1"><StatValue value={s.value} /></div>
                    ...
                    <div className="max-w-5xl mx-auto flex flex-col items-center gap-6">
                        ...
                        <div className="flex flex-wrap justify-center gap-6 mt-8 w-full">
                            {isLoading ? (
                                ...
                                feedbackList?.map((t, i) => (
                                    <Reveal key={t.created_at || i} delay={i * 100} className="w-full sm:w-[320px]">
                        ...
                        <Reveal delay={300}>
                            <div className="flex flex-col sm:flex-row items-center gap-4 mt-8">
                                <a href="/studio" className="inline-flex items-center gap-2 h-12 px-8 rounded-xl bg-primary text-white text-sm font-bold hover:bg-blue-700 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-primary/20 group">
